...
1. Find the key `Enter the objectID for GroupMember group copied from Microsoft admin center` and replace the existing value with the `GroupAdmin` object id from Azure.
