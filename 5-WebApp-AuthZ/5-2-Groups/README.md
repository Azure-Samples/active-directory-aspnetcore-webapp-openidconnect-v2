...
1. Find the key `Enter the objectID for GroupMember group copied from Microsoft Entra admin center` and replace the existing value with the `GroupMember` object id from Azure.
