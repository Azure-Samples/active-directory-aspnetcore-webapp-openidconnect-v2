...
For the Azure Storage preparation see [Authenticate with Microsoft Entra ID from an application for access to blobs and queues](https://docs.microsoft.com/en-us/azure/storage/common/storage-auth-ME-ID-app)
...
To access Azure Resource Management (ARM), you'll need a work or school account (ME-ID account) and an Azure subscription. If your Azure subscription is for a Microsoft personal account, just create a new user in your directory, and use this user to run the sample
