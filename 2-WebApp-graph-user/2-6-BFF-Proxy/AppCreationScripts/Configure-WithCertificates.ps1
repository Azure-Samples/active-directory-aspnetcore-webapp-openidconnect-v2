...
Function ConfigureApplications
{
   ...
   Write-Host "Creating the AAD application (CallGraphBFF)"
   # create the application 
   $clientAadApplication = New-MgApplication -DisplayName "CallGraphBFF" `
                                                      -Web `
                                                      @{ `
                                                          RedirectUris = "https://localhost:7000/api/auth/signin-oidc", "https://localhost:7000/api/auth/signout-oidc"; `
                                                          HomePageUrl = "https://localhost:7000"; `
                                                        } `
    ...
    #Update-MgApplication -ApplicationId $currentAppObjectId -IdentifierUris @("https://$tenantName/CallGraphBFF")
    # Generate a certificate

    Write-Host "Creating the client application (CallGraphBFF)"

    $certificateName = 'CallGraphBFF'
    ...
    Write-Host "Done creating the client application (CallGraphBFF)"
    ...
    Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>CallGraphBFF</a></td></tr>" -Path createdApps.html
