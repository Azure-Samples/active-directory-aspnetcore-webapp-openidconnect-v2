...
> This sample is for Microsoft Entra ID, not Azure AD B2C.
...
When it comes to developing apps, developers can choose to configure their app to be either single-tenant or multi-tenant during app registration in the [Microsoft admin center](https://portal.azure.com).
...
1. Sign in to the [National cloud Microsoft admin center](https://docs.microsoft.com/en-us/azure/active-directory/develop/authentication-national-cloud#app-registration-endpoints) using either a work or school account or a personal Microsoft account.
...
1. In the **Register an application page** that appears, enter your application's registration information:
   - In the **Name** section, enter a meaningful application name that will be displayed to users of the app, for example `WebApp_MultiTenant_v2`.
...
1. Find the app key `ClientId` and replace the existing value with the application ID (clientId) of the `WebApp_MultiTenant_v2` application copied from the Microsoft admin center.
...
1. Find the app key `ClientSecret` and replace the existing value with the key you saved during the creation of the `WebApp_MultiTenant_v2` app, in the Microsoft admin center.
