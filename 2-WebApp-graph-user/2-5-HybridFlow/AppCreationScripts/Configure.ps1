...
Function ConfigureApplications
{
   ...
   # Get a 6 months application key for the HybridFlowAspNetCore Application
   ...
   $HybridFlowAspNetCoreAadApplication = New-MgApplication -DisplayName "HybridFlowAspNetCore" `
    ...
    $pwdCredential = Add-MgApplicationPassword -ApplicationId $HybridFlowAspNetCoreAadApplication.Id -PasswordCredential $key
    $HybridFlowAspNetCoreAppKey = $pwdCredential.SecretText
    ...
    $appSettingsObject.AzureAd = ConvertFrom-Json '{"Instance":"https://login.microsoftonline.com/","Domain":"Auto","TenantId":"Auto","ClientId":"Auto","ClientSecret":"Auto","CallbackPath":"/signin-oidc","WithSpaAuthCode":true,"ClientCertificates":[]}';
    ...
    $appSettingsObject.AzureAd.ClientSecret = $pwdCredential.SecretText;
