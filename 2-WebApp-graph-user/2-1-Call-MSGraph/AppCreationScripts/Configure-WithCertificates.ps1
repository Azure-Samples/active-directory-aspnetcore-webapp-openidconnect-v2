...
Function ConfigureApplications
{
   ...
   $webAppAadApplication = New-MgApplication -DisplayName "WebApp-OpenIDConnect-DotNet-graph-v2" `
                                                      -Web `
                                                      @{ `
    ...
    #Update-MgApplication -ApplicationId $currentAppObjectId -IdentifierUris @("https://$tenantName/WebApp-OpenIDConnect-DotNet-graph-v2")
    # Generate a certificate

    Write-Host "Creating the webApp application (WebApp-OpenIDConnect-DotNet-graph-v2)"

    $certificateName = 'WebApp-OpenIDConnect-DotNet-graph-v2'
    ...
    $webAppKeyCredentials = Update-MgApplication -ApplicationId $currentAppObjectId `
    ...
    Write-Host "Successfully registered and configured that app registration for 'WebApp-OpenIDConnect-DotNet-graph-v2' at `n $webAppPortalUrl" -ForegroundColor Green 
