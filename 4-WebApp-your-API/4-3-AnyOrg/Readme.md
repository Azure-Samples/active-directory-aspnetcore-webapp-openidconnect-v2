...
1. In the **Client secrets** section, select **New client secret**:
    ...
    1. In the **Delegated permissions** section, select **User.Read.All** in the list. Use the search box if necessary. **The scope should get an Admin Consent, so don't forget to ass it manually**
