...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "TodoListClient-aspnetcore-webapi" `
    ...
    $dictionary = @{ "Domain" = $tenantName;"TenantId" = $tenantId;"ClientId" = $clientAadApplication.AppId;"KeyVaultCertificateName" = $certificateName;"TodoListScope" = ("api://"+$serviceAadApplication.AppId+"/access_as_user");"TodoListBaseAddress" = $serviceAadApplication.Web.HomePageUrl };
