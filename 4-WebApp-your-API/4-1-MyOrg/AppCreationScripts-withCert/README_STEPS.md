...
Since we will be using a certificate instead of a client secret in this sample, we will first create a new self-signed certificate. If you have an actual valid certificate available, you can skip the following step.
...
1. Find the key `KeyVaultCertificateName` and replace the existing value with $certificateName.
